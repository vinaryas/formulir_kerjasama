...
@section('content')
<form class="card" action="{{ route('lingkup.update') }}" method="POST">
    {{ csrf_field() }}
    <div class="card-body">
        <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" id="lingkup" name="lingkup" value="{{ $lingkupKerjasama->lingkup }}" class="form-control" required>
            </div>
        </div>
        <br>
